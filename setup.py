...
setup(
  ...
  version = '0.076',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/endsley/wuML/archive/refs/tags/0.076.tar.gz',    # I explain this later on

...
setup(
  ...
  version = '0.041',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/endsley/wuML/archive/refs/tags/0.041.tar.gz',    # I explain this later on

...
def rbk_kernel(X, Y=None, sigma=1, zero_diagonal=False, use_random_features=False, random_feature_method='rff', random_feature_width=500):
	...
	if use_random_features:
		...
		γ = 1.0/(2*σ*σ)
		Kx = sklearn.metrics.pairwise.rbf_kernel(X, Y, gamma=γ)

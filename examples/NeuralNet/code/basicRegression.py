...
lp = wplotlib.lines(newX, Ŷline, title='Without Batch Normalization', show=False)	# show must be false if it is a subplot

splot = wplotlib.scatter(data.X, data.Y, marker='o', show=False, subplot=122)
lp = wplotlib.lines(newX, Ŷline, title='With Batch normalization')	
